                    ...
                    if (1 > a.parent("div.jq-checkbox").length) {
                        var e = function() {
                            ...
                            b.on("click.styler", function() {
                                b.is(".disabled") || (a.is(":checked") ? (a.prop("checked", !1),
                ...
                a.each(function() {
                    if (1 > a.parent("div.jq-radio").length) {
                        var s = function() {
                            ...
                            a.is(":disabled") && b.addClass("disabled");
                            b.on("click.styler", function() {
                                b.is(".disabled") || (b.closest(e.wrapper).find('input[name="' + a.attr("name") + '"]').prop("checked", !1).parent().removeClass("checked"),
                    ...
                    if (1 > a.parent("div.jq-file").length) {
                        var s = function() {
                            ...
                            a.on("change.styler", function() {
                                var c = a.val();
                                if (a.is("[multiple]"))
                                    for (var c = "", e = a[0].files, n = 0; n < e.length; n++)
                                        c += (0 < n ? ", " : "") + e[n].name;
                                g.text(c.replace(/.+[\\\/]/, ""));
                                "" === c ? (g.text(b),
                        ...
                        var s = function() {
                            ...
                            function b() {
                                for (var a = 0, c = g.length; a < c; a++) {
                                    ...
                                    void 0 !== g.eq(a).attr("class") && (d = " " + g.eq(a).attr("class"),
                                    w = ' data-jqfs-class="' + g.eq(a).attr("class") + '"');
                                    var u = g.eq(a).data(), f;
                                    for (f in u)
                                        "" !== u[f] && (n += " data-" + f + '="' + u[f] + '"');
                                    "" !== e + d && (b = ' class="' + e + d + '"');
                                    b = "<li" + w + n + b + ">" + g.eq(a).html() + "</li>";
                                    g.eq(a).parent().is("optgroup") && (void 0 !== g.eq(a).parent().attr("class") && (p = " " + g.eq(a).parent().attr("class")),
                                    b = "<li" + w + ' class="' + e + d + " option" + p + '">' + g.eq(a).html() + "</li>",
                                    g.eq(a).is(":first-child") && (b = '<li class="optgroup' + p + '">' + g.eq(a).parent().attr("label") + "</li>" + b));
                                    s += b
                                }
                            }
                            function h() {
                                ...
                                if (void 0 === y || "" === y)
                                    y = e.selectSearch;
                                if (void 0 === h || "" === h)
                                    h = e.selectSearchLimit;
                                if (void 0 === x || "" === x)
                                    x = e.selectSearchNotFound;
                                void 0 === p && (p = e.selectSearchPlaceholder);
                                if (void 0 === w || "" === w)
                                    w = e.singleSelectzIndex;
                                if (void 0 === u || "" === u)
                                    u = e.selectSmartPositioning;
                                ...
                                f.data("jqfs-class", r.data("jqfs-class")),
                                f.addClass(r.data("jqfs-class")));
                                if (a.is(":disabled"))
                                    return f.addClass("disabled"),
                                    !1;
                                E.click(function() {
                                    ...
                                    if (!navigator.userAgent.match(/(iPad|iPhone|iPod)/i)) {
                                        ...
                                        !0 === u || 1 === u ? r > y + C + 20 ? (k(),
                                        f.removeClass("dropup").addClass("dropdown")) : (t(),
                                        f.removeClass("dropdown").addClass("dropup")) : (!1 === u || 0 === u) && r > y + C + 20 && (k(),
                                        f.removeClass("dropup").addClass("dropdown"));
                                        c("div.jqselect").css({
                                            zIndex: w - 1
                                        }).removeClass("opened");
                                        f.css({
                                        ...
                                        l.is(":hidden") ? (c("div.jq-selectbox__dropdown:visible").hide(),
                                        l.show(),
                                        f.addClass("opened focused"),
                                        e.onSelectOpened.call(f)) : (l.hide(),
                                        f.removeClass("opened dropup dropdown"),
                                        c("div.jq-selectbox").filter(".opened").length && e.onSelectClosed.call(f));
                                        z.length && (z.val("").keyup(),
                                        v.hide(),
                                        z.keyup(function() {
                                            var b = c(this).val();
                                            m.each(function() {
                                        ...
                                        m.filter(".selected").length && (0 !== q.innerHeight() / p % 2 && (p /= 2),
                                        q.scrollTop(q.scrollTop() + m.filter(".selected").position().top - q.innerHeight() / 2 + p));
                                        n(q);
                                        return !1
                                    }
                                });
                                ...
                                c(document).on("click", function(a) {
                                    c(a.target).parents().hasClass("jq-selectbox") || "OPTION" == a.target.nodeName || (c("div.jq-selectbox").filter(".opened").length && e.onSelectClosed.call(c("div.jq-selectbox").filter(".opened")),
                                    z.length && z.val("").keyup(),
                                    l.hide().find("li.sel").addClass("selected"),
                                    f.removeClass("focused opened dropup dropdown"))
                                })
                            }
                            function d() {
                                var e = new A
                                ...
                                v > d.height() && (k.css("overflowY", "scroll"),
                                n(k),
                                h.filter(".selected").length && k.scrollTop(k.scrollTop() + h.filter(".selected").position().top));
                                a.prependTo(d).css({
                                    position: "absolute",
                                    left: 0,
                                    top: 0,
